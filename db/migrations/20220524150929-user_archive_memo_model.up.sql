...
CREATE TABLE "public"."user_archive_access" (
  user_id UUID NOT NULL FOREIGN KEY REFERENCES "public"."users" (UUID),
...
CREATE TABLE "public"."user_ackfock" (
  user_id UUID NOT NULL FOREIGN KEY REFERENCES "public"."users" (UUID),
  memo_id UUID NOT NULL FOREIGN KEY REFERENCES "public"."memo" (UUID),
  ackfcok ackfock NOT NULL,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
...
INSERT INTO "public"."user_ackfock" (user_id, memo_id, ackfock)
SELECT target_user_id, uuid, target_user_id
  FROM "public"."memo"
